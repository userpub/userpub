...
GITHUB_REPOSITORY_NAME = 'r13-team-241'
LINODE_SERVER_HOSTNAME = '173.255.253.140'
...
after 'deploy:update_code' do
  ...
  run "cd #{release_path}; RAILS_ENV=production runuser -l www-app -c 'bundle exec rake bower:install'"
  # Compile Assets
